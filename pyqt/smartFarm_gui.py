...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(130, 100, 551, 41))
        font = QtGui.QFont()
        ...
        self.connectButton.setGeometry(QtCore.QRect(160, 260, 501, 101))
...
"font: 18pt \"NanumSquare\";")
        ...
        self.reconnectButton = QtWidgets.QPushButton(self.errorPage)
        self.reconnectButton.setGeometry(QtCore.QRect(160, 260, 501, 101))
        self.reconnectButton.setStyleSheet("background-color: rgb(81, 163, 0);\n"
"font: 18pt \"NanumSquare\";")
        self.reconnectButton.setObjectName("reconnectButton")
        self.label_4 = QtWidgets.QLabel(self.errorPage)
        self.label_4.setGeometry(QtCore.QRect(130, 100, 551, 41))
        font = QtGui.QFont()
        font.setFamily("NanumSquare")
        font.setPointSize(24)
        self.label_4.setFont(font)
        self.label_4.setStyleSheet("color: rgb(213, 0, 3);")
        self.label_4.setAlignment(QtCore.Qt.AlignCenter)
        self.label_4.setObjectName("label_4")
        self.stackedWidget.addWidget(self.errorPage)
        self.mainPage = QtWidgets.QWidget()
        self.mainPage.setObjectName("mainPage")
        self.navigation_bar = QtWidgets.QWidget(self.mainPage)
        ...
        self.farmStack = QtWidgets.QStackedWidget(self.mainPage)
        self.farmStack.setGeometry(QtCore.QRect(0, 70, 800, 413))
        self.farmStack.setObjectName("farmStack")
...
"border : none;")
        ...
        self.farmStack.addWidget(self.page)
        self.page_2 = QtWidgets.QWidget()
        self.page_2.setObjectName("page_2")
        self.farmStack.addWidget(self.page_2)
        ...
        self.farmStack.addWidget(self.page_3)
        ...
        self.farmStack.addWidget(self.page_4)
        self.stackedWidget.addWidget(self.mainPage)
        MainWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(MainWindow)
        self.stackedWidget.setCurrentIndex(1)
        self.farmStack.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.label_3.setText(_translate("MainWindow", "Welcome to Smartfarm - ESC"))
        ...
        self.label_4.setText(_translate("MainWindow", "ERROR: Invaild Connection"))
